...
function NavbarComponent({ setShowLoginModla }) {
            ...
            <div className="d-flex col-12">
                <div className="d-flex col-12  justify-content-between align-items-center" >
                    ...
                    <div className="col-7 d-flex justify-content-center align-items-center">
                        <div className="col-4">
                            <input placeholder="search for item" className="form-control col-12" type="text"></input>
                        </div>
                        <div className="col-6 ms-5 d-flex">
                            <select className="form-select ms-2" id="inputGroupSelect01">
                    ...
                    <div className="me-3">
                        <button type="button" className="btn btn-secondary" onClick={() => setShowLoginModla(true)}>Login</button>
                    </div>
